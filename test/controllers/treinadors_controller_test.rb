...
class TreinadorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treinador" do
    assert_difference('Treinador.count') do
      post treinadors_url, params: { treinador: { especialidade: @treinador.especialidade, idade: @treinador.idade, nome: @treinador.nome, sexo: @treinador.sexo } }
    end
  ...
  test "should update treinador" do
    patch treinador_url(@treinador), params: { treinador: { especialidade: @treinador.especialidade, idade: @treinador.idade, nome: @treinador.nome, sexo: @treinador.sexo } }
